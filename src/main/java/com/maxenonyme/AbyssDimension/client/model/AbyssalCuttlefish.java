...
public class AbyssalCuttlefish<T extends AbyssalCuttlefishEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // eyes — cubes at generated positions within head-space pivot
        head.addOrReplaceChild("eyes", CubeListBuilder.create()
            .texOffs(208, 224).addBox(16.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F)
            .texOffs(208, 224).mirror().addBox(-32.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F),
